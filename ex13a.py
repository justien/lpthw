...
script, animals, homes, foods = argv

print "The script is called:", script
print
print "Category one is:", animals
print "Category two is:", homes
print "Category three is:", foods 
...
print
print "Manifesting the %s category now." % choice
print "%s !!" % choice
