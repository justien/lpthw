...
def gold_room():
    ...
    if "0" in choice or "1" in choice:
        ...
        dead("Sorry, we only accept binary around here.")
        
    if how_much < 50:
        print "Noice!  Not too greedy, oi loik it! You WINNN!!"
        exit(0)  
    else:
        dead("U so greedy! So much gold all for you!")
...
# This is a keep-alive while-loop.  So you might like to make sure that there's
# a way out of it.
