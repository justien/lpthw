...
# Open the library sys, and make the argv function available to 
# the script.
from sys import argv

# assign the command line arguments to these variables using argv
script, filename = argv

# create a variable 'txt', which is a shortcut for typing 
# the command to open the filename specified in the command line
txt = open(filename)
